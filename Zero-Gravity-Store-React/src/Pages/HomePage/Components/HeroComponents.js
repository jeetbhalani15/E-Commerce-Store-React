      ...
      <div className="landing-box">
        <div className="landing-img">
          ...
          <div className="hero-title">
            ...
            <button className="hero-btn btn-solid">
        ...
        <div className="my-card">
          <div>
            <h1 className="cart-heading">Games on Sale</h1>
          </div>
          <div className="card-content">
            <div className="card-vertical-box flex card-border">
              <div className="vertical-card flex">
                <div className="card-top">
                  <img
                    className="card-img"
                    src="https://cdn1.epicgames.com/b4565296c22549e4830c13bc7506642d/offer/TETRA_PREORDER_STANDARD EDITION_EPIC_Store_Portrait_1200x1600-1200x1600-ca8b802ff13813c37a44ebf68d0946a2.png?h=854&resize=1&w=640"
                    alt=""
                  />
                </div>
            ...
            <div className="hero-catergory">
              <div>
                <h1 className="cart-heading">Plateforms</h1>
              </div>
              <div className="genre">
            ...
            <div className="hero-catergory">
              <div>
                <h1 className="cart-heading">Featured Games</h1>
              </div>
              <div className="genre">
